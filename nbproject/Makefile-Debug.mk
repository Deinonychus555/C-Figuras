...
${OBJECTDIR}/exceptionRgb.o: exceptionRgb.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/exceptionRgb.o exceptionRgb.cpp

${OBJECTDIR}/factoriaFigura.o: factoriaFigura.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factoriaFigura.o factoriaFigura.cpp

${OBJECTDIR}/factoriaFiguraInicializacion.o: factoriaFiguraInicializacion.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factoriaFiguraInicializacion.o factoriaFiguraInicializacion.cpp

${OBJECTDIR}/factoriaRectangulo.o: factoriaRectangulo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factoriaRectangulo.o factoriaRectangulo.cpp

${OBJECTDIR}/factoriaSegmento.o: factoriaSegmento.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factoriaSegmento.o factoriaSegmento.cpp

${OBJECTDIR}/factoriaTriangulo.o: factoriaTriangulo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factoriaTriangulo.o factoriaTriangulo.cpp
...
${OBJECTDIR}/segmento.o: segmento.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/segmento.o segmento.cpp
